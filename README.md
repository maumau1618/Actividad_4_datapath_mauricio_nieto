...
export LOCATION="US"
export PIPELINE_PATH="models/pipeline.joblib"
export XTEST_TABLE="your-project.dataset.iris_data"
export FEATURES_TABLE="your-project.dataset.selected_features" 
export PREDICTIONS_TABLE="your-project.dataset.predictions"
export MODEL_NAME="iris-logistic-regression"
